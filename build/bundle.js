    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			p1 = element("p");
    			t6 = text("This template is pre-configured with svlete-spa-router for routing.");
    			br = element("br");
    			t7 = text("\n  Visit the ");
    			a1 = element("a");
    			a1.textContent = "documentation for the router";
    			t9 = text(" to learn more.");
    			add_location(h1, file, 0, 0, 0);
    			attr_dev(a0, "href", "https://svelte.dev/tutorial");
    			add_location(a0, file, 1, 13, 35);
    			add_location(p0, file, 1, 0, 22);
    			add_location(br, file, 3, 69, 205);
    			attr_dev(a1, "href", "https://github.com/ItalyPaleAle/svelte-spa-router");
    			add_location(a1, file, 4, 12, 224);
    			add_location(p1, file, 2, 0, 132);
    		},
    		l: function claim(nodes) {
